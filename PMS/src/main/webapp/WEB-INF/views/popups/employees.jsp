...
<style>
:root{
  --line:#dcdfe6; --bg:#f6f7fb; --text:#303133; --muted:#909399; --blue:#409eff;
}
*{box-sizing:border-box}
body{font-family:Segoe UI, Malgun Gothic, Apple SD Gothic Neo, sans-serif; color:var(--text); margin:0}
.wrap{padding:14px}
...
<!-- 캐시 무력화 위해 버전 파라미터 추가 -->
<script src="<c:url value='/resources/js/popup-common.js?v=20250930a'/>"></script>
<script>
  // 팝업 설정
  window.POPUP_CONFIG = {
    title: '사원',
    ...
    columns: [
      ...
      { key:'deptCode',       name:'부서코드',     width:60  },
      { key:'workDeptName',   name:'근무부서',     width:110 },
      { key:'positionName',   name:'직위',         width:60  },
      { key:'titleName',      name:'직급',         width:60  },
      { key:'dutyName',       name:'직책',         width:60  },
      { key:'appointDate',    name:'발령일',       width:100, format:'date' }, // 날짜
      { key:'workStatusName', name:'재직/퇴직구분', width:110 },
      { key:'workStatusDetail', name:'근무상태',   width:80  },
